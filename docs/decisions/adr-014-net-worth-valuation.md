...
- Supersedes: —  
- Amended by: ADR-019 (Net worth subtracts outstanding loan principal), ADR-020 (Net worth includes cannon and warehouse resale value) — the cash/ship/cargo formula decided here is unchanged; both ADRs add terms once their respective features shipped  
- Superseded by: —  
