...
13. **Not yet gated on the city view / not yet started**: bulk-purchase price pressure (`market-formula.md`), combat system (ADR-010 — cannons exist but do nothing without it)
